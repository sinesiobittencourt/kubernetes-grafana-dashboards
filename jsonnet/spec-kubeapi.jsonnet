  ...
  rows: [
    {
      ...
      panel_title: 'API Error ratio 500s/total (except $verb_excl)',
      formula: |||
        sum by (verb, code)(
      ...
      |||,
      graf_legend: '{{ verb }} - {{ code }}',
      threshold: 0.01
    },
    {
      title: 'API Latency',
      panel_title: 'API $api_percentile-th latency[ms] by verb (except $verb_excl)',
      formula: |||
        histogram_quantile (
            0.$api_percentile,
            sum by (le, verb)(
